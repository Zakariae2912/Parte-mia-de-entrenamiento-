...
# ODDS RATIOS Y COEFICIENTES DE LA REGRESION LOGISTICA
# VALIDACION INTERCENTRO LOSO.
# ============================================================
...
def crear_grafico_or(
    resultados_or,
    hospital_train,
    ruta_salida
):

    # Seleccionar las 15 variables con mayor coeficiente absoluto

    resultados_top = sorted(
        resultados_or,
        key=lambda fila: abs(fila[1]),
        reverse=True
    )[:15]

    # Ordenarlas para facilitar la lectura del gráfico horizontal
...
# Ordenar las variables por la magnitud absoluta
    # de sus coeficientes
...
print("\nOdds ratios del modelo entrenado con Hospital A:")

tabla_or_AB.orderBy(
    F.desc(F.abs(F.col("coeficiente")))
).show(
    truncate=False
)

print("\nOdds ratios del modelo entrenado con Hospital B:")
...
# ------------------------------------------------------------
# EXPORTACIÓN DE LAS TABLAS DE ODDS RATIOS
# ------------------------------------------------------------

ruta_output_or = (
    "file:///home/adminp/TFA3/output/odds_ratios"
)
...
ruta_grafico_or_AB = (
    "/home/adminp/TFA3/output/odds_ratios/"
    "03_OR_entrena_A_valida_B.html"
)

ruta_grafico_or_BA = (
    "/home/adminp/TFA3/output/odds_ratios/"
    "04_OR_entrena_B_valida_A.html"
)
...
print("\nGráficos de odds ratios creados:")
print(ruta_grafico_or_AB)
print(ruta_grafico_or_BA)
